...
include('controller/pmainfoJSONcall.php');
?>
<html>
    <head><title>PMA Info</title>
        <link rel="stylesheet" type="text/css" href="./view/css/style.css">
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <script src="controller/pmainfoJSONcall.js"></script>
...
<center>
    <div id="pma_id_grab" style ="visibility: hidden;"><?php echo $_GET['pma_id']; ?></div>
    <h2><?php echo $_GET['name']; ?> PMA Details</h2>
</center>
<p id="putpma"></p>
